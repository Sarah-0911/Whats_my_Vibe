  ...
  return (
    <li className="p-2 shadow-xl bg-slate-200 rounded">
      ...
      <div className="mt-2">
        ...
        target="_blank"
        className="flex max-w-24 items-center justify-center gap-2 mt-4 mb-1 font-barlow uppercase text-sm font-semibold border rounded-full px-3 py-2 bg-slate-900 text-orange-200 hover:bg-slate-950 hover:-translate-y-0.5 duration-300"
