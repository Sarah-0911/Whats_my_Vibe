...
export default function Doodle() {
  return (
    <>
      <img className="absolute left-36 bottom-24 md:bottom-10 md:left-72 w-12 md:w-20 h-auto rotate-12" src={audioTape} alt="audioTape icon" />
      ...
      <img className="absolute top-56 md:top-24 left-1/3 w-12 md:w-20 h-auto" src={harmonica} alt="harmonica icon" />
