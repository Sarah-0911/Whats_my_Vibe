...
export default function Doodle() {
  return (
    <>
      <img className="absolute bottom-10 left-72 w-20 h-auto rotate-12" src={audioTape} alt="audioTape icon" />
      ...
      <img className="absolute bottom-6 right-96 w-6 h-auto rotate-12" src={eighthNote} alt="eighthNote icon" />
